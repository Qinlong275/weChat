...
public class BannerLayout extends RelativeLayout {
    ...
    private int WHAT_AUTO_PLAY = 700;
    ...
    private int autoPlayDuration = 700;
    ...
    public void initView(String url1, String url2){
        //之后要改，根据传入的URL数决定
        itemCount=2;
        List<View> views = new ArrayList<>();
        views.add(getImageView(0,url1));
        views.add(getImageView(1,url2));
        views.add(getImageView(0,url1));
        views.add(getImageView(1,url2));
        setViews(views);
    }

    private ImageView getImageView(final int position, String resoureId){
        ...
        Glide.with(getContext()).load(resoureId).into(imageView);
        return imageView;
    }
